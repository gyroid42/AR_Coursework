...
namespace gef
{
	...
	public:
		...
		void RenderText(SpriteRenderer* renderer, const Vector4& pos, const float scale, const UInt32 colour, const TextJustification justification, const char * text, va_list args) const;
